...
export const Sidebar = () => {
  ...
  return (
    <aside
      className={
        'hidden h-screen w-20 flex-col items-center border-r border-r-slate-100 bg-white p-4 dark:border-r-slate-800 dark:bg-slate-900 sm:fixed sm:flex xl:w-72 xl:items-start'
      }
    >
      <Link href="/">
